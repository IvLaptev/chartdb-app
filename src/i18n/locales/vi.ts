    ...
    translation: {
        ...
        export_diagram_dialog: {
            ...
            error: {
                ...
                description: 'Có gì đó không ổn. Cần trợ giúp? chartdb@ya.ru',
            },
        },
        ...
        import_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'Sơ đồ ở dạng JSON không hợp lệ. Vui lòng kiểm tra JSON và thử lại. Bạn cần trợ giúp? chartdb@ya.ru',
            },
        },
