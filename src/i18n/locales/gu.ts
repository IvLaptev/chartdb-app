    ...
    translation: {
        ...
        export_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'કશુક તો ખોટું થયું. મદદ જોઈએ? chartdb@ya.ru પર સંપર્ક કરો.',
            },
        },
        ...
        import_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'ડાયાગ્રામ JSON અમાન્ય છે. કૃપા કરીને JSON તપાસો અને ફરી પ્રયાસ કરો. મદદ જોઈએ? chartdb@ya.ru પર સંપર્ક કરો.',
            },
        },
